...
class DFS():
    ...
    def Sinh_Trang_Thai_Ke_Tiep_DFS(self,Trang_Thai_HT, hang_doi, visited, TT_Dich, parent):
    ...
    def DFS(self,Trang_Thai_Ban_Dau, TT_Dich):
        ngan_xep = []
        ngan_xep.append(Trang_Thai_Ban_Dau)
        visited = set()
        visited.add(Trang_Thai_Ban_Dau)
        parent = {}
        while ngan_xep:
            Trang_Thai_HT = ngan_xep.pop()
            if self.La_Dich(Trang_Thai_HT, TT_Dich):
                ...
                path.reverse()
                return path
            self.Sinh_Trang_Thai_Ke_Tiep_DFS(Trang_Thai_HT, ngan_xep, visited, TT_Dich, parent)
